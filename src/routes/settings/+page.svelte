...
<div class="max-w-1xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
  <div class="mb-8">
                ...
                <div class="flex h-6 shrink-0 items-center">
                  <div class="group grid size-4 grid-cols-1">
                    <input 
                      id="comments" 
                      type="checkbox" 
                      bind:checked={formData.comments}
                ...
                <div class="flex h-6 shrink-0 items-center">
                  <div class="group grid size-4 grid-cols-1">
                    <input 
                      id="candidates" 
                      type="checkbox" 
                      bind:checked={formData.candidates}
            ...
            <div class="mt-6 space-y-6">
              <div class="flex items-center gap-x-3">
                <input 
                  id="push-everything" 
                  type="radio" 
                  bind:group={formData.pushNotifications}
                  value="everything"

    ...
    <form on:submit|preventDefault={handleSubmitUpdate}>
      <div class="space-y-4">
        ...
        <div>
          ...
          <div class="mt-2">
            <textarea id="edit_activity_from" bind:value={form.from} rows="1" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"></textarea>
          </div>
        </div>
        <div>
          <label for="edit_activity_to" class="block text-sm/6 font-medium text-gray-900">To (Optional)</label>
          <div class="mt-2">
            <textarea id="edit_activity_to" bind:value={form.to} rows="1" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"></textarea>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input type="file" id="edit_attachment_file" accept="image/*,application/pdf" on:change={handleAttachmentChange} class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" />
            {#if formFileName}
